...
import pandas as pd
import itertools
#pip install ortools and pandas to use this
...
# ----------------------------- sample usage  -----------------------------
# data = [
#   # player_id, name, position, team_id, cost,  gw1, gw2, gw3, gw4
#   [1, "GK A", "GK", "ARS", 4.5, 6, 1, 2, 8],
#   [2, "DEF A","DEF","ARS", 5.0, 2, 7, 6, 1],
#   ...
# ]
#
# # 1) fresh optimize from scratch
# squad_ids, xi_ids, captain_id = pick_fpl_team(data)
# print("15-man:", squad_ids)
# print("XI:", xi_ids)
# print("C:", captain_id)
#
# # 2) keep EXACTLY 2 transfers from the current 15 (e.g., rolling in 2 FTs)
# current_15 = [ ... 15 player_ids you already own ... ]
# new_squad_ids, xi_ids2, captain_id2 = pick_fpl_team_with_transfers(data, current_15, transfers=2)
# print("new 15:", new_squad_ids)
# print("XI (new):", xi_ids2)
# print("C (new):", captain_id2)
